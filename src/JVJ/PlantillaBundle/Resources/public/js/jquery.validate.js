...
$.extend($.validator, {
	...
	messages: {
		...
		range: $.validator.format("Por favor ingrese un valor entre {0} and {1}."),
		max: $.validator.format("Por favor ingrese un valor menos que o igual a {0}."),
		min: $.validator.format("Por favor ingrese un valor mas que o igual a{0}.")
	},
	...
	prototype: {
		...
		showLabel: function(element, message) {
			...
			var message = message + '<span class="tip"></span>';
