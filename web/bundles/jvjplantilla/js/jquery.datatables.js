	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sZeroRecords": "No hay mas filas",
				"sEmptyTable": "No hay datos en la tabla",
				"sLoadingRecords": "Cargando...",
				"sInfo": "Viendo _START_ hasta _END_ de  _TOTAL_ filas",
				"sInfoEmpty": "viendo 0 hasta 0 de 0 filas",
				"sInfoFiltered": "(buscado para _MAX_ total de filas)",
				"sInfoPostFix": "",
				"sInfoThousands": ",",
		...
		function _fnCreateCookie ( sName, sValue, iSecs, sBaseName, fnCallback )
		{
			...
			if ( fnCallback !== null )
			{
				...
				sFullCookie = fnCallback( sNameFile, oData, date.toGMTString(),
					aParts.join('default.htm')+"/" );
			}
			else
			{
				sFullCookie = sNameFile + "=" + encodeURIComponent(sValue) +
					"; expires=" + date.toGMTString() +"; path=" + aParts.join('default.htm')+"/";
			}
